...
tests = Test.create!([
  { title: 'Ruby basic test', level: 0, category_id: categories[0].id }, 
  { title: 'Ruby advanced test', level: 2, category_id: categories[0].id },
  { title: 'Ruby for hackers test', level: 3, category_id: categories[0].id },
  { title: 'Coffee knowledge test', level: 1, category_id: categories[3].id },
  { title: 'Metasploit test', level: 1, category_id: categories[1].id },
])
